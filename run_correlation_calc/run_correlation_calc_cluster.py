...
def run_simulation(_save_dir,
    ...
    if reduced_x_manifold:
        ...
        x_states = [
            'x0', 'x1M', 'x1', 'x1P', 'x2MM', 'x2M', 'x2', 'x2P', 'x2PP',
            'x3MMM', 'x3MM', 'x3M', 'x3', 'x3P', 'x3PP', 'x3PPP', 'x1M_d1',
    ...
    correlator_class = TimeBinPhotonCorrelationsCluster(
        ...
        _n_steps_vst=int(5000 * _len_stirap),
...
if __name__ == "__main__":
    ...
    run_simulation(_save_dir="saved_data_timebin/photon_correlations/n_3/",n_sim_steps=sim_steps, n_photons=2, b_field="0p07", _n_start=2, _len_stirap=1, _two_photon_det_2=0, _two_photon_det_4=0, _plot=True)
